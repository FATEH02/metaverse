...
CREATE TABLE "MapapElements" (
    ...
    CONSTRAINT "MapapElements_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "MapapElements_id_key" ON "MapapElements"("id");
...
-- AddForeignKey
ALTER TABLE "MapapElements" ADD CONSTRAINT "MapapElements_mapId_fkey" FOREIGN KEY ("mapId") REFERENCES "Map"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "MapapElements" ADD CONSTRAINT "MapapElements_elementId_fkey" FOREIGN KEY ("elementId") REFERENCES "Element"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
